...
#define NAVA_TRACK_DMP  0x01
#define NAVA_CONFIG_DMP 0x02
#define NAVA_FULL_DMP   0x03

// Request command's 
#define NAVA_BANK_REQ   0x40
#define NAVA_TRACK_REQ  0x41
#define NAVA_CONFIG_REQ 0x42
#define NAVA_FULL_REQ   0x43
